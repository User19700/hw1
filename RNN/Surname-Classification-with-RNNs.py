...
args = Namespace(
    ...
    surname_csv=os.path.join(script_dir, "surnames_with_splits.csv"),  # 动态生成绝对路径
    vectorizer_file=os.path.join(script_dir, "vectorizer.json"),
    model_state_file=os.path.join(script_dir, "model.pth"),
    save_dir=os.path.join(script_dir, "model_storage/ch6/surname_classification"),
